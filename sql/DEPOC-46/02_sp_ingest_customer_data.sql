-- DEPOC-46: Main pipeline stored procedure with GEOGRAPHY support and fixed error counting
...
$$
DECLARE
    v_load_id VARCHAR; v_source_file VARCHAR;
    v_total_rows NUMBER DEFAULT 0; v_valid_rows NUMBER DEFAULT 0;
    v_invalid_rows NUMBER DEFAULT 0; v_inserted_rows NUMBER DEFAULT 0;
    v_updated_rows NUMBER DEFAULT 0; v_duplicate_rows NUMBER DEFAULT 0;
BEGIN
    ...
    COPY INTO DE_POC.PUBLIC.RAW_CUSTOMERS (
        ...
        CREATED_DATE, UPDATED_DATE, GEOGRAPHY
    )
    ...
    IF (:v_already_processed > 0 AND :v_total_rows = 0) THEN
        ...
        SET STATUS = 'SKIPPED', ERROR_MESSAGE = 'Source already processed.', TOTAL_ROWS = 0, COMPLETED_AT = CURRENT_TIMESTAMP()
    ...
    SELECT :v_load_id, :v_source_file,
           OBJECT_CONSTRUCT('CUSTOMER_ID', CUSTOMER_ID, 'FIRST_NAME', FIRST_NAME, 'EMAIL', EMAIL),
    ...
    -- Fixed: COUNT(*) instead of COUNT(DISTINCT CUSTOMER_ID)
    ...
    USING (
        SELECT * FROM (
            SELECT CUSTOMER_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE,
                ADDRESS, CITY, STATE, COUNTRY, POSTAL_CODE, GEOGRAPHY,
    ...
    WHEN MATCHED AND (src.UPDATED_DATE > tgt.UPDATED_DATE OR tgt.UPDATED_DATE IS NULL) THEN UPDATE SET
        ...
        tgt.POSTAL_CODE = src.POSTAL_CODE, tgt.GEOGRAPHY = src.GEOGRAPHY,
    ...
    WHEN NOT MATCHED THEN INSERT (
        CUSTOMER_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE, ADDRESS, CITY, STATE, COUNTRY, POSTAL_CODE, GEOGRAPHY,
        ...
        src.ADDRESS, src.CITY, src.STATE, src.COUNTRY, src.POSTAL_CODE, src.GEOGRAPHY,
